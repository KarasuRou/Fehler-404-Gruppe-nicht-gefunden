...
public class Output {
    ...
    private static final String PATH = System.getProperty("user.dir") + System.getProperty("file.separator") + "logs";
    private static final String FILE_PATH = PATH + System.getProperty("file.separator") +
